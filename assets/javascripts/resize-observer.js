(function (global, factory) {
    ...
    var Scheduler = (function () {
        ...
        Object.defineProperty(Scheduler.prototype, "scheduled", {
            get: function () {
                return scheduled;
            },
            enumerable: false,
    ...
    var handleEvent = function () { return observedElements && scheduler.schedule(); };
    var mo = new MutationObserver(handleEvent);
    var getDocument = function (node) {
        var root = node.getRootNode ? node.getRootNode({ composed: node.nodeType === 11 }) : node.ownerDocument;
        if (root && root !== node) {
    ...
    var observeElementTree = function (element) {
        var _a;
        var document = getDocument(element);
        var window = (_a = element.ownerDocument) === null || _a === void 0 ? void 0 : _a.defaultView;
        while (window) {
            addWindow(window);
    ...
    var registerAddition = function (element) {
        observeElementTree(element);
        observedElements++;
        handleEvent();
    };
    var registerRemoval = function (element) {
        observedElements--;
    };
